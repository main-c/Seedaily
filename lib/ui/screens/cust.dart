...
class _CustomizePlanScreenState extends State<CustomizePlanScreen> {
  ...
  /// Header avec aperçu du template (image, titre, description)
  Widget _buildTemplateHeader() {
    return Column(
      ...
      children: [
        ...
        ClipRRect(
          borderRadius: BorderRadius.circular(16),
          child: _template.image.isNotEmpty
              ? Image.network(
                  _template.image,
                  width: double.infinity,
                  height: 180,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Configurer le plan'),
        actions: [
          IconButton(
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                isSelected ? AppTheme.seedGold : Colors.white,
                            borderRadius: BorderRadius.circular(8),
                            border: isSelected
                                ? null
                                : Border.all(
                  ...
                  // ═══════════════════════════════════════════════════
                  // SECTION 2 : VUE GLOBALE (SELON FORMAT SÉLECTIONNÉ)
                  // ═══════════════════════════════════════════════════
                  if (_previewDays.isNotEmpty) ...[
                  ...
                  children: [
                    ...
                    if (_canCustomizeDistribution) ...[
                      ...
                      if (_showDailyPsalmProverb)
                        CheckboxListTile(
                          ...
                          subtitle:
                              const Text('Ajouter un proverbe chaque jour'),
                      ...
                      CheckboxListTile(
                        ...
                        subtitle:
                            const Text('Lire les livres en ordre inverse'),
                        value: _reverse,
                        onChanged: (value) {
                          setState(() {
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        print(
                            'Building chip for ${format['label']} - selected: $isSelected');
                        return ChoiceChip(
                          label: Row(
                    ...
                    CheckboxListTile(
                      ...
                      subtitle:
                          const Text('Suivre votre progression de lecture'),
                    ...
                    CheckboxListTile(
                      ...
                      subtitle: const Text(
                          'Colorier selon les genres bibliques (PDF)'),
